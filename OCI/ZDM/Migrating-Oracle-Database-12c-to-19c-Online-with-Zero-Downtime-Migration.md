...
1. [Prerequisites for a Smooth Migration](#prerequisites-for-a-smooth-migration)
1. [Preparing the Migration Plan with the Response File](#preparing-the-migration-plan-with-the-response-file)
    1. [Key parameters](#key-parameters-for-a-12c-to-19c-online-logical-migration-include)
1. [Crucial First Step: Run CPAT](#crucial-first-step-run-cpat)
1. [Executing the Migration Job](#executing-the-migration-job)
1. [Monitoring the Migration](#monitoring-the-migration)
1. [Application Switchover and Post-Migration](#application-switchover-and-post-migration) 
